...
export function golferProfileRow(p: GolferProfileInput, userId: string): Row {
  return {
    ...
    handicap_source: p.handicap_source ?? 'self_reported',
    handicap_verified_at: p.handicap_verified_at ?? null,
...
export function rowToGolferProfile(r: Row | null): GolferProfileInput | null {
  ...
  return {
    ...
    ghin_number: r.ghin_number == null ? null : str(r.ghin_number),
    handicap_source: str(r.handicap_source, 'self_reported') as GolferProfileInput['handicap_source'],
    handicap_verified_at: r.handicap_verified_at == null ? null : str(r.handicap_verified_at),
