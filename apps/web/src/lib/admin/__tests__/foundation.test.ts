...
function systemStub(over: Partial<SystemStatus> = {}): SystemStatus {
  return {
    capabilities: { auth: true, aiCoach: true, aiVision: true, ocr: true, email: true, billing: false, ads: false },
    integrations: [
...
describe('deriveAlerts', () => {
  ...
  it('warns when AI vision is off', () => {
    const sys = systemStub({ capabilities: { auth: true, aiCoach: true, aiVision: false, ocr: true, email: true, billing: false, ads: false } });
