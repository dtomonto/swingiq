...
export const ADAPTERS: readonly AdapterDef[] = [
  ...
  },
  {
    ...
    sourceType: 'webhook',
    mode: 'automated',
    blurb: 'Accept signals POSTed by Zapier/Make/your own automations.',
    envVars: ['SIGNALRADAR_WEBHOOK_SECRET'],
    keyless: false,
    setupInstructions: 'Set SIGNALRADAR_WEBHOOK_SECRET, then POST normalized mentions to the (future) /api/signal-radar/webhook endpoint with that secret.',
    dedupeStrategy: 'Provided id or URL.',
  },
  {
    id: 'reddit',
    name: 'Reddit search',
