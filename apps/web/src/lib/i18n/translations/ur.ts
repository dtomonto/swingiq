...
export const ur: PartialTranslations = {
  ...
  language: { title: 'زبان', change: 'زبان تبدیل کریں', setting: 'ایپ کی زبان', helperText: 'SwingIQ کے لیے زبان منتخب کریں۔ آپ کی ترجیح آپ کے ڈیٹا بیک اپ میں محفوظ کی جائے گی۔' },
  community: { title: 'SwingIQ کمیونٹی', subtitle: 'اپنے سیشنز کو سلسلوں، بیجز اور دیرپا ترقی میں بدلیں۔' },
