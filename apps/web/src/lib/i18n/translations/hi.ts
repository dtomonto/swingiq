...
export const hi: PartialTranslations = {
  ...
  language: { title: 'भाषा', change: 'भाषा बदलें', setting: 'ऐप भाषा', helperText: 'SwingVantage के लिए भाषा चुनें। आपकी प्राथमिकता आपके डेटा बैकअप में सहेजी जाएगी।' },
  community: { title: 'SwingVantage समुदाय', subtitle: 'अपने सत्रों को लकीर, बैज और स्थायी प्रगति में बदलें।' },
