...
export const ar: PartialTranslations = {
  ...
  language: { title: 'اللغة', change: 'تغيير اللغة', setting: 'لغة التطبيق', helperText: 'اختر لغة SwingIQ. سيتم حفظ تفضيلك في نسخة احتياطية من بياناتك.' },
  community: { title: 'مجتمع SwingIQ', subtitle: 'حوّل جلساتك إلى سلاسل وشارات وتحديات وتقدم دائم.' },
