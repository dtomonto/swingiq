...
export function summarize(
  ...
  return {
    ...
    failedUploads24h: countEvents(events, (e) => e.type === 'video_upload_failed', nowMs, DAY),
    failedAnalyses24h: countEvents(events, (e) => e.type === 'video_processing_failed', nowMs, DAY),
    failedSyncs24h: countEvents(events, (e) => e.category === 'database', nowMs, DAY),
