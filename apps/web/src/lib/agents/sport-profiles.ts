...
export const SPORT_AGENT_PROFILES: Record<SportId, SportAgentProfile> = {
  ...
  pickleball: {
    ...
    motion: 'stroke',
    inputNoun: 'video',
    equipmentNoun: 'paddle',
    defaultFocus: 'a compact stroke with paddle-face control and contact out front',
    defaultCue: 'Short backswing, soft hands, meet it out front — let your legs lift the ball.',
    preGameLabel: 'Pre-Match',
    filmingTips: [
      'Film side-on so paddle-face angle, contact height, and the dink/drop arc are visible.',
      'Capture a few reps of the same shot (dink, drop, or drive) rather than mixing.',
      'Keep the whole compact stroke and the kitchen line in frame.',
    ],
    preGameThoughts: [
      'Compact preparation and contact out front.',
      'Soft hands at the kitchen — be patient, wait for the ball to pop up.',
    ],
    preGameWarmup: 'Dink cross-court to feel soft hands, then drops and drives, finishing with a few serves and returns.',
    preGameAvoid: 'Do not take a long tennis backswing or speed up balls below net height.',
  },
  padel: {
    id: 'padel',
    label: 'Padel',
    ...
    inputNoun: 'video',
    equipmentNoun: 'racket',
    defaultFocus: 'controlled overheads (bandeja) and reading the ball off the glass',
    defaultCue: 'Give the wall space, prepare early, and control the bandeja to hold the net.',
    preGameLabel: 'Pre-Match',
    filmingTips: [
      'Film side-on so the overhead (bandeja/víbora) and contact height are visible.',
      'Capture back-glass reps so the wall read and recovery are in frame.',
      'Include net volleys and lobs to show your positioning.',
    ],
    preGameThoughts: [
      'Control the bandeja and hold the net.',
      'Give balls off the glass space — let the wall bring them back to you.',
    ],
    preGameWarmup: 'Volleys at the net, then bandejas and lobs, finishing with a few back-glass rebounds and serves.',
    preGameAvoid: 'Do not overhit the smash when a bandeja holds the net, or crowd the ball against the glass.',
  },
  baseball: {
    id: 'baseball',
    label: 'Baseball',
