...
export function CameraAngleSelector({ value, onChange, disabled }: CameraAngleSelectorProps) {
  return (
    <div className="space-y-3">
      <div>
        <h3 className="text-sm font-semibold text-foreground">Camera angle</h3>
      ...
      {value === 'down_the_line' && (
        <div className="rounded-lg bg-accent-secondary/10 border border-accent-secondary/25 p-3 text-xs text-accent-secondary">
