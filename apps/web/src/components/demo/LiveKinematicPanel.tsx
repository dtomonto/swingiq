...
const SOFTBALL: SwingProfile = {
  keys: [
    [0.0, 128, 4, -8, 3, 0.55, 0.26, 0, 0],
    [0.14, 138, 16, 30, 6, 0.5, 0.3, 2, 1],
    [0.3, 130, 24, 54, 8, 0.5, 0.36, 3, 1],
    [0.46, 100, 2, 32, 2, 0.56, 0.52, -1, 0], // deeper knee — drop under the ball
    [0.6, -22, -26, 8, -6, 0.54, -0.98, -6, -1], // contact — bat angled up (uppercut)
    [0.74, -78, -48, -52, -9, 0.44, -0.95, -4, -3], // high extension
    [0.88, -148, -56, -78, -7, 0.4, -0.72, 0, -4],
    [0.95, -148, -56, -78, -7, 0.4, -0.72, 0, -4],
    [1.0, 128, 4, -8, 3, 0.55, 0.26, 0, 0],
  ],
  contact: { x: 98, y: 156 },
  groundStrike: false,
  launch: { x: -1, y: -0.78 }, // higher arc
  impactU: 0.6,
};
...
const PADEL: SwingProfile = {
  keys: [
    ...
    [0.12, 58, 12, 24, 3, 0.5, 0.28, 2, 1],
    [0.3, 90, 20, 44, 5, 0.48, 0.4, 3, 1],
    [0.5, 32, 2, 22, 0, 0.52, 0.24, 0, 0],
    [0.62, -18, -18, 8, -4, 0.5, -0.3, -3, -1], // contact — upward flick
    [0.8, -78, -30, -36, -5, 0.46, -0.45, -1, -3],
    [0.92, -104, -36, -46, -4, 0.44, -0.3, 1, -3],
    [0.97, -104, -36, -46, -4, 0.44, -0.3, 1, -3],
