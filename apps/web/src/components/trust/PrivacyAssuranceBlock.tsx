...
export function PrivacyAssuranceBlock({ className = '' }: { className?: string }) {
  return (
    <div className={`rounded-2xl border border-gray-200 bg-white p-6 ${className}`}>
      <h3 className="mb-4 text-base font-bold text-gray-900">Your data stays yours</h3>
      ...
      <Link href="/trust" className="mt-4 inline-block text-sm font-semibold text-green-700 hover:underline">
