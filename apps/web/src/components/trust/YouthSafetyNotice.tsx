    ...
    >
      ...
      <div className="text-sm text-foreground">
        ...
        <p className="mt-1 text-muted-foreground">
          SwingVantage is a general-audience improvement tool, and young athletes are welcome with a parent
          or guardian involved — anyone under 13 should use SwingVantage through a parent or guardian. Please
