...
const TONE: Record<InsightTone, { ring: string; icon: typeof Sparkles; iconColor: string }> = {
  info: { ring: 'border-l-blue-400', icon: Sparkles, iconColor: 'text-blue-500' },
  success: { ring: 'border-l-green-500', icon: TrendingUp, iconColor: 'text-green-600' },
  celebrate: { ring: 'border-l-green-500', icon: PartyPopper, iconColor: 'text-green-600' },
  warning: { ring: 'border-l-amber-400', icon: AlertTriangle, iconColor: 'text-amber-500' },
  safety: { ring: 'border-l-red-500', icon: ShieldCheck, iconColor: 'text-red-500' },
};
    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          {showWhy && (
            <div className="mt-2 text-xs text-gray-600 space-y-1.5 bg-gray-50 rounded-lg p-3">
