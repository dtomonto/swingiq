...
// Client list for the blog index: search + sport filter over a server-provided
// set of posts. The posts come from the override-aware server read
// (getEffectivePublicBlogPosts) so a durable PublishingOS publish decision is
// reflected here in production — the client just filters what the server sent.
