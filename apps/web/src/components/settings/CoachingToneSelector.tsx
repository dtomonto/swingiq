        ...
        {COACHING_TONES.map((t) => {
          ...
          return (
            <button
              ...
              className={cn(
                'flex flex-col items-start gap-0.5 rounded-xl border-2 px-3 py-2.5 text-left transition-colors focus:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1',
