...
export default function AdminAgentRegistryPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-4 sm:p-6">
        ...
        <SectionCard
          ...
          title={
            <span className="flex items-center gap-2">
              ...
              {group.family.label}
              <span className="text-xs font-normal text-muted-foreground">({group.agents.length})</span>
            </span>
          }
      ...
      <HelpPanel>
        <p>
          <strong className="text-foreground">What this is.</strong> A single, honest inventory of every
        ...
        <p>
          <strong className="text-foreground">Keyless-first.</strong> Most agents are deterministic and run
        ...
        <p>
          <strong className="text-foreground">Safety.</strong> Guardrails (youth/medical safety, the trust
    ...
    <div className="flex flex-col rounded-xl border border-border bg-background/40 p-4">
      ...
      <dl className="mt-3 space-y-1 text-xs text-muted-foreground">
        <div className="flex gap-2">
          <dt className="w-16 shrink-0 text-muted-foreground/70">Reads</dt>
          <dd className="text-muted-foreground">{agent.inputs.join(', ')}</dd>
        </div>
        <div className="flex gap-2">
          <dt className="w-16 shrink-0 text-muted-foreground/70">Produces</dt>
          <dd className="text-muted-foreground">{agent.outputs.join(', ')}</dd>
        </div>
        <div className="flex gap-2">
          <dt className="w-16 shrink-0 text-muted-foreground/70">Control</dt>
          <dd className="text-muted-foreground">{agent.control}</dd>
        </div>
      </dl>
