...
const SECTIONS = [
  ...
  },
  {
    ...
    terms: [
      ...
      { term: 'Heuristic Analysis', def: 'Analysis based on rules, patterns, and thresholds rather than direct measurement. SwingIQ video analysis is heuristic — it estimates what may be happening based on observable cues rather than pixel-level pose tracking. Results are labeled as estimates.' },
