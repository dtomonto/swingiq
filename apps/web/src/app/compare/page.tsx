    ...
    return (
      <AppShell>
        <div className="p-6 max-w-5xl mx-auto">
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Session Comparison</h1>
      ...
      <div className="p-6 max-w-5xl mx-auto space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">
            Pick two sessions to compare your swing data side by side.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm bg-white focus:ring-2 focus:ring-green-500 outline-none"
            >
              {sorted.map((s) => (
