  ...
  return (
    <div className="relative isolate overflow-hidden bg-stage text-stage-foreground">
      ...
      <section className="mx-auto max-w-5xl px-4 pt-16 pb-12 text-center sm:pt-20">
        ...
        <p className="mx-auto mt-5 max-w-2xl text-pretty text-base leading-relaxed text-stage-foreground sm:text-lg">
        ...
        <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
          <a
            href="#lab-map"
            className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-emerald-500 px-6 py-3 text-sm font-bold text-stage shadow-lg shadow-emerald-500/20 transition-all hover:bg-emerald-400 hover:shadow-emerald-400/30 focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-300 focus-visible:ring-offset-2 focus-visible:ring-offset-stage sm:w-auto"
          >
            <MapIcon size={17} aria-hidden="true" /> Explore the lab map
          </a>
          <a
            href="#roadmap"
            className="inline-flex w-full items-center justify-center gap-2 rounded-xl border border-white/15 bg-white/5 px-6 py-3 text-sm font-bold text-white transition-colors hover:bg-white/10 focus:outline-none focus-visible:ring-2 focus-visible:ring-white/40 focus-visible:ring-offset-2 focus-visible:ring-offset-stage sm:w-auto"
          >
        ...
        <p className="mx-auto mt-5 max-w-xl text-sm text-stage-muted">
        ...
        <div className="mt-9 flex flex-wrap items-center justify-center gap-2">
          {LAB_SPORTS.map((s) => (
            <span key={s} className="rounded-full border border-white/10 bg-white/[0.04] px-3 py-1 text-xs font-medium text-stage-foreground">
              {s}
            </span>
          ))}
        </div>
      ...
      <section id="concept" className="mx-auto max-w-5xl scroll-mt-24 px-4 py-14">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-base leading-relaxed text-stage-foreground">{SWINGLAB_COPY.conceptLead}</p>
        </div>
        ...
        <div className="mt-10 rounded-3xl border border-white/10 bg-white/[0.02] p-6 sm:p-8">
          ...
          <p className="mt-2 max-w-2xl text-sm text-stage-muted">
      ...
      <section id="lab-map" className="mx-auto max-w-5xl scroll-mt-24 px-4 py-10">
        <div className="mx-auto mb-7 max-w-3xl text-center">
          ...
          <p className="mt-4 text-base leading-relaxed text-stage-foreground">
          ...
          {LAB_FLOW.map((step, i) => (
            <li key={step.title} className="flex gap-4 rounded-2xl border border-white/10 bg-white/[0.02] p-5">
              ...
              <div>
                ...
                <p className="mt-1 text-sm leading-relaxed text-stage-muted">{step.detail}</p>
              </div>
            </li>
          ))}
        </ol>
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {LAB_VALUE.map((v) => (
            <div key={v.title} className="rounded-2xl border border-white/10 bg-white/[0.02] p-5">
              ...
              <p className="mt-2 text-sm leading-relaxed text-stage-muted">{v.detail}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="mx-auto max-w-5xl px-4 pb-20 pt-6">
        <div className="relative overflow-hidden rounded-3xl border border-emerald-400/20 bg-gradient-to-br from-emerald-500/10 via-stage-panel/40 to-cyan-500/10 p-8 text-center sm:p-12">
          ...
          <div className="relative">
            ...
            <p className="mx-auto mt-3 max-w-2xl text-base leading-relaxed text-stage-foreground">
            ...
            <div className="mt-7 flex flex-col items-center justify-center gap-3 sm:flex-row">
              <Link
                ...
                className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-emerald-500 px-6 py-3 text-sm font-bold text-stage shadow-lg shadow-emerald-500/20 transition-all hover:bg-emerald-400 focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-300 focus-visible:ring-offset-2 focus-visible:ring-offset-stage sm:w-auto"
              >
        ...
        <nav aria-label="Related" className="mt-10 flex flex-wrap justify-center gap-x-6 gap-y-2 text-sm">
          ...
          <Link href="/features" className="text-stage-muted transition-colors hover:text-white">All features</Link>
          <Link href="/how-it-works" className="text-stage-muted transition-colors hover:text-white">How it works</Link>
          <Link href="/motion-lab" className="text-stage-muted transition-colors hover:text-white">Motion Lab (3D)</Link>
          <Link href="/agi" className="text-stage-muted transition-colors hover:text-white">Athlete Intelligence</Link>
          <Link href="/start" className="text-stage-muted transition-colors hover:text-white">Start free</Link>
        </nav>
      </section>
    </div>
  );
