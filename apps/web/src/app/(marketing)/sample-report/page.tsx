...
export const metadata = buildMetadata({
  ...
  description:
    'See exactly what a SwingVantage report looks like — the top priority fix, the evidence behind it, drills, a 7-day plan, and how to retest. Examples for all seven sports.',
  path: '/sample-report',
});
