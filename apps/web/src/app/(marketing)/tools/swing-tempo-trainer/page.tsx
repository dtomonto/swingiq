...
export const metadata = buildMetadata({
  ...
  description:
    'A free audio-visual swing tempo trainer. Play the classic 3:1 backswing-to-downswing rhythm — Set, Top, Strike — with a pendulum that swings in time. No account, nothing recorded.',
