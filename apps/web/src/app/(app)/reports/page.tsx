...
export default function ReportsPage() {
  const { sessions, profile, clubs, training, sportProfiles, video_analyses } = useSwingVantageStore();
  ...
  const coachReport = useMemo(() => {
    const lines: string[] = [];
    lines.push('=== SwingVantage Player Report ===');
    ...
    lines.push('');
    lines.push('Generated by SwingVantage — swingvantage.com');

    return lines.join('\n');
  }, [sorted, profile, clubs, training, activeSport, isGolf, sportAnalyses, sportName, sportProfiles]);
